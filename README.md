[1.html](https://github.com/user-attachments/files/25478962/1.html)
...
<div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div class="onlyforchrome" style="font-size: 30px;text-align: center;font-family: Helvetica;">This page is NOT available.              Maybe you want to play this game.</div>
    <div class="onlyforchrome" style="margin-top:5px;text-align:center;color:#8a8a8a;margin-bottom:80px; font-size:.8em;line-height:1.2em;font-family: Georgia;"><a href="http://www.thecodepost.org/internet/play-hidden-t-rex-game-offline-chrome/" target="_blank"><strong>T-Rex Dino game</strong></a> from Google Chrome offline mode ripped by <a href="https://www.twitter.com/thecodepost" target="_blank"><strong>@thecodepost</strong></a>.
 Press "Space" to jump your Dino and start the game.</div>
  ...
  <script type="text/javascript">
    if (navigator.userAgent.toLowerCase().indexOf('chrome') > -1) {
      ...
      document.getElementById("main-frame-notchrome").style.display="";
					...
					The Dino Game program is NOT by me. The website is by me.
								(C) 2019 VMSum. All rights reseived.
